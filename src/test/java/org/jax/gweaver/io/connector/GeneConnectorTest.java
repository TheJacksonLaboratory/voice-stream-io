...
public class GeneConnectorTest extends AbstractDataFileTest {
	...
	public void simpleGeneRead1() throws Exception {
		...
		AbstractScanner<GeneticEntity> reader = ReaderFactory.getReader(new ReaderRequest("Homo sapiens", getFile("data/1000/hs_gtf/hg38_2.gtf")));
	...
	public void simpleGeneRead2() throws Exception {
		...
		AbstractScanner<GeneticEntity> reader = ReaderFactory.getReader(new ReaderRequest("Mus musculus", getFile("data/1000/mm_gtf/mm10_2.gtf")));
		List<Entity> found = reader.stream()
	...
	public void geneZipRead1() throws Exception {
		...
		AbstractScanner<GeneticEntity> reader = ReaderFactory.getReader(new ReaderRequest("Homo sapiens", getFile("data/zip/hs_gtf/hg38_1.gtf.zip")));
	...
	public void geneZipRead2() throws Exception {
		...
		AbstractScanner<GeneticEntity> reader = ReaderFactory.getReader(new ReaderRequest("Mus musculus", getFile("data/zip/mm_gtf/mm10_1.gtf.zip")));
		long count = reader.stream().flatMap(n->connector.apply(n)).count();
